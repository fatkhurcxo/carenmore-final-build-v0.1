<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item" {{ active_class(['admin/tagihan']) }}>
                <a href="{{ url('admin/tagihan') }}" class="nav-link">
                    <i class="link-icon" data-feather="clock"></i>
                    <span class="link-title">Tagihan Layanan</span>
                </a>
            </li>
            {{-- END PRIMARY --}}
            {{-- PENYEDIA JASA --}}
            <li class="nav-item nav-category">penyedia jasa</li>
            <li class="nav-item {{ active_class(['admin/data-provider']) }} ">
                <a href="{{ url('admin/data-provider') }}" class="nav-link">
                    <i class="link-icon" data-feather="book"></i>
                    <span class="link-title">Provider</span>
                </a>
            </li>
            <li class="nav-item {{ active_class(['admin/data-layanan']) }} ">
                <a href="{{ route('admin.view.layanan') }}" class="nav-link">
            ...
            <li class="nav-item {{ active_class(['admin/data-customer']) }}">
                <a href="{{ url('admin/data-customer') }}" class="nav-link">
            ...
            <li class="nav-item">
                <a href="" class="nav-link">
                    ...
                    <span class="link-title">Promo Aktif</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="" class="nav-link">
                    <i class="link-icon" data-feather="trending-up"></i>
                    <span class="link-title">Pengajuan Promo</span>
                </a>
            </li> --}}
            {{-- END PROMO --}}
            {{-- EMAIL --}}
