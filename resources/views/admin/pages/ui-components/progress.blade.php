...
@section('content')
    <div class="row">
        <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
            ...
            <p class="lead">Documentation and examples for using Bootstrap custom progress bars featuring support for
                stacked bars, animated backgrounds, and text labels. Read the <a
                    href="https://getbootstrap.com/docs/4.5/components/progress/" target="_blank">Official Bootstrap
                    Documentation</a> for a full list of instructions and other options.</p>

            <hr>

            <h4 id="default">Basic example</h4>
            <p class="mb-3">Progress components are built with two HTML elements, some CSS to set the width, and a few
                attributes.</p>
            <div class="example">
                <div class="progress">
  ...
  <div class="progress-bar" role="progressbar" style="width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">25%</div>
            ...
            <p class="mb-3">We only set a <code>height</code> value on the <code>.progress</code>, so if you change that
...
<div class="progress">
  ...
  <div class="progress-bar bg-danger" role="progressbar" style="width: 20%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <p class="mb-3">Add <code>.progress-bar-striped</code> to any <code>.progress-bar</code> to apply a stripe
  ...
  <div class="progress-bar progress-bar-striped" role="progressbar" style="width: 10%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
            ...
            <p class="mb-3">The striped gradient can also be animated. Add <code>.progress-bar-animated</code> to
