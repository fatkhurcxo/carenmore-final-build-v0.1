    ...
    <div class="row">
        <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
            ...
            <p class="lead">Use Bootstrap’s custom button styles for actions in forms, dialogs, and more with support for
                multiple sizes, states, and more. Read the <a href="https://getbootstrap.com/docs/4.5/components/buttons/"
...
<button type="button" class="btn btn-link">Link</button></script></code></pre>
                <button type="button" class="btn btn-clipboard" data-clipboard-target="#defaultButton"><i
...
<input class="btn btn-primary" type="reset" value="Reset"></script></code></pre>
            ...
            <figure class="highlight" id="outlineButton">
                ...
                <button type="button" class="btn btn-clipboard" data-clipboard-target="#outlineButton"><i
                        data-feather="copy"></i></button>
            </figure>
...
<button type="button" class="btn btn-primary btn-xs">Extra small</button></script></code></pre>
            ...
            <p class="mb-3">Create block level buttons—those that span the full width of a parent—by adding
...
<button type="button" class="btn btn-secondary" disabled>Button</button></script></code></pre>
                <button type="button" class="btn btn-clipboard" data-clipboard-target="#disabledButton"><i
                        data-feather="copy"></i></button>
            </figure>
            <p class="mb-3">Disabled buttons using the <code>&lt;a&gt;</code> element behave a bit different.
                ...
                <code>.disabled</code> class to make it visually appear disabled.</p>
            <div class="example">
...
<a href="#" class="btn btn-secondary disabled" tabindex="-1" role="button" aria-disabled="true">Link</a></script></code></pre>
                <button type="button" class="btn btn-clipboard" data-clipboard-target="#defaultButton2"><i
                        data-feather="copy"></i></button>
            </figure>
