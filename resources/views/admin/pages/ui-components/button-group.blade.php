...
@section('content')
    <div class="row">
        <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
            ...
            <p class="lead">Group a series of buttons together on a single line with the button group, and super-power them
                with javascript. Read the <a href="https://getbootstrap.com/docs/4.5/components/button-group/"
  ...
  <div class="btn-group" role="group" aria-label="Third group"> ... </div>
                ...
                <button type="button" class="btn btn-clipboard" data-clipboard-target="#buttonToolbar"><i
                        data-feather="copy"></i></button>
            </figure>
  ...
  <div class="btn-group" role="group">
    ...
    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
      ...
      <a class="dropdown-item" href="#">Dropdown link</a>
                ...
                <button type="button" class="btn btn-clipboard" data-clipboard-target="#buttonNesting"><i
                        data-feather="copy"></i></button>
            </figure>
    ...
    ...
                ...
                <button type="button" class="btn btn-clipboard" data-clipboard-target="#verticalVariations"><i
                        data-feather="copy"></i></button>
            </figure>
