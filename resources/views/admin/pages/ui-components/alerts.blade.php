    ...
    <div class="row">
        <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
            ...
            <p class="lead">Provide contextual feedback messages for typical user actions with the handful of available and
                flexible alert messages. Read the <a href="https://getbootstrap.com/docs/4.5/components/alerts/"
            ...
            <p class="mb-3">Alerts are available for any length of text, as well as an optional dismiss button. For proper
                styling, use one of the eight required contextual classes (e.g., <code>.alert-success</code>).</p>
            <div class="example">
...
<div class="alert alert-dark" role="alert">...</div></script></code></pre>
                <button type="button" class="btn btn-clipboard" data-clipboard-target="#defaultAlert"><i
  ...
  A simple primary alert—check it out!
            ...
            <p class="mb-3">Add class <code>.alert-icon-*</code> with <code>.alert</code>. then include an icon inside the
                div.</p>
            <div class="example">
  ...
  A simple primary alert—check it out!
            ...
            <p class="mb-3">Use the <code>.alert-link</code> utility class to quickly provide matching colored links
                within any alert.</p>
            <div class="example">
                <div class="alert alert-primary" role="alert">
  ...
  <p class="mb-0">Whenever you need to, be sure to use margin utilities to keep things nice and tidy.</p>
                ...
                <button type="button" class="btn btn-clipboard" data-clipboard-target="#additionalContent"><i
                        data-feather="copy"></i></button>
            </figure>
            <hr>
            ...
            <ul>
                <li>Add a dismiss button and the <code>.alert-dismissible</code> class, which adds extra padding to the
                    right of the alert and positions the <code>.close</code> button.</li>
                <li>On the dismiss button, add the <code>data-dismiss="alert"</code> attribute, which triggers the
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
                ...
                <button type="button" class="btn btn-clipboard" data-clipboard-target="#dismissingAlert"><i
                        data-feather="copy"></i></button>
            </figure>
