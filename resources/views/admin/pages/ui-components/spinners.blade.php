...
@section('content')
    <div class="row">
        <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
            ...
            <p class="df-lead">Indicate the loading state of a component or page with Bootstrap spinners, built entirely with
                HTML, CSS, and no JavaScript. Read the <a href="https://getbootstrap.com/docs/4.5/components/spinners/"
  ...
  <span class="sr-only">Loading...</span>
            ...
            <p class="mb-3">The border spinner uses <code>currentColor</code> for its <code>border-color</code>, meaning
...
<div class="spinner-border text-dark" role="status">
  <span class="sr-only">Loading...</span>
            ...
            <p class="mb-3">If you don’t fancy a border spinner, switch to the grow spinner. While it doesn’t technically
  ...
  <span class="sr-only">Loading...</span>
            ...
            <p class="mb-3">Use flexbox utilities, float utilities, or text alignment utilities to place spinners exactly
  ...
  <div class="spinner-border ml-auto" role="status" aria-hidden="true"></div>
                ...
                <button type="button" class="btn btn-clipboard" data-clipboard-target="#alignmentFlex"><i
                        data-feather="copy"></i></button>
            </figure>
  ...
  <div class="spinner-border float-right" role="status">
    <span class="sr-only">Loading...</span>
                ...
                <button type="button" class="btn btn-clipboard" data-clipboard-target="#alignmentFlot"><i
                        data-feather="copy"></i></button>
            </figure>
  ...
  <div class="spinner-border" role="status">
    <span class="sr-only">Loading...</span>
            ...
            <h4 id="size">Size</h4>
            <p class="mb-3">Add <code>.spinner-border-sm</code> and <code>.spinner-grow-sm</code> to make a smaller
...
<div class="spinner-grow spinner-grow-sm" role="status">
  <span class="sr-only">Loading...</span>
            ...
            <p class="mb-3">Use spinners within buttons to indicate an action is currently processing or taking place.
