        ...
        <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
            ...
            <p class="lead">Responsive navigation header, the navbar. Includes support for branding, navigation, and more,
                including support for our collapse plugin. Read the <a
                    href="https://getbootstrap.com/docs/4.5/components/navbar/" target="_blank">Official Bootstrap
            ...
            <div class="example">
                ...
                <nav class="navbar navbar-light bg-light">
                    <a class="navbar-brand" href="#">
                        <img src="{{ url('assets/images/logo-placeholder.png') }}" width="30" height="30"
                            alt="">
                    </a>
                </nav>
            </div>
...
<nav class="navbar navbar-light bg-light">
  <a class="navbar-brand" href="#">
    ...
    Logo
            ...
            <p class="mb-3">Place various form controls and components within a navbar with <code>.form-inline</code>.
            </p>
            <div class="example">
                <nav class="navbar navbar-light bg-light">
