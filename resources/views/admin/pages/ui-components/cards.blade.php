...
@section('content')
    <div class="row">
        <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
            ...
            <p class="lead">A flexible and extensible content container with multiple variants and options. Read the <a
                    href="https://getbootstrap.com/docs/4.5/components/card/" target="_blank">Official Bootstrap
                    ...
                    <div class="col-12 col-md-6 col-xl-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text mb-1">With supporting text below as a natural lead-in to additional
                                    content.</p>
                                <a href="#" class="btn btn-primary">Go somewhere</a>
                            </div>
                        </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="#" class="btn btn-primary">Go somewhere</a>
                ...
                <button type="button" class="btn btn-clipboard" data-clipboard-target="#cardNavigation"><i
                        data-feather="copy"></i></button>
            </figure>
  ...
  <div class="card text-white bg-dark">
    ...
    <div class="card"> ... </div>
            ...
            <p class="mb-3">Need a set of equal width and height cards that aren’t attached to one another? Use card
                decks.</p>
            <div class="example">
                <div class="card-deck">
                    <div class="card">
    ...
    <div class="card"> ... </div>
            ...
            <p>Cards can be organized into <a href="https://masonry.desandro.com/" target="_blank">Masonry</a>-like
                columns with just CSS by wrapping them in <code>.card-columns</code>. Cards are built with CSS
                <code>column</code> properties instead of flexbox for easier alignment. Cards are ordered from top to bottom
                and left to right.
            </p>
            <div class="example">
