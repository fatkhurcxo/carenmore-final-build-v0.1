                        ...
                        <div class="col-lg-3 email-aside border-lg-right">
                            <div class="aside-content">
                                ...
                                <div class="aside-compose"><a class="btn btn-primary btn-block"
                                        href="{{ url('/email/compose') }}">Compose Email</a></div>
                                <div class="aside-nav collapse">
                                    <ul class="nav">
                                        <li class="active"><a href="{{ url('/email/inbox') }}"><span class="icon"><i
                        ...
                        <div class="col-lg-9 email-content">
                            <div class="email-head">
                                ...
                                <div class="email-head-sender d-flex align-items-center justify-content-between flex-wrap">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar">
                                            <img src="{{ url('https://via.placeholder.com/36x36') }}" alt="Avatar"
