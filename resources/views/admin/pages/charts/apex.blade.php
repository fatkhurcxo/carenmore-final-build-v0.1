        ...
        <div class="col-md-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <p>Modern & Interactive Open-source Charts. Read the <a href="https://apexcharts.com/" target="_blank">
                            Official ApexChart Documentation</a> for a full list of instructions and other options.</p>
                </div>
            </div>
        </div>
    </div>
