                            ...
                            <div class="aside-content">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pb-2 mb-2">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a class="dropdown-item d-flex align-items-center" href="#"><i
                                                        data-feather="aperture" class="icon-sm mr-2"></i> <span
                                                        class="">Add status</span></a>
                                                <a class="dropdown-item d-flex align-items-center" href="#"><i
                                                        data-feather="settings" class="icon-sm mr-2"></i> <span
                                ...
                                <div class="aside-body">
                                    <ul class="nav nav-tabs mt-3" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="calls-tab" data-toggle="tab" href="#calls"
                                                        ...
                                                        <a href="javascript:;" class="d-flex align-items-center">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex flex-column align-items-end">
                                                                    ...
                                                                    <div class="badge badge-pill badge-primary ml-auto">5
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </a>
                                                        ...
                                                        <a href="javascript:;" class="d-flex align-items-center">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex flex-column align-items-end">
                                                                    ...
                                                                    <div class="badge badge-pill badge-danger ml-auto">3
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </a>
                                                    ...
                                                    <li class="chat-item pr-1">
                                                        <a href="javascript:;" class="d-flex align-items-center">
                                                            ...
                                                            <div
                                                                class="d-flex justify-content-between flex-grow border-bottom">
                                                                <div>
                                                                    <p class="text-body font-weight-bold">Leonardo Payne
                                                                    </p>
                                                                    <div class="d-flex align-items-center">
                                                                        <i data-feather="image"
                                                                            class="text-muted icon-md mb-2px"></i>
