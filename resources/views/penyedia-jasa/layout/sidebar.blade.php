<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item {{ active_class(['provider']) }}">
                <a href="{{ url('/provider') }}" class="nav-link">
                    <i class="link-icon" data-feather="box"></i>
                    <span class="link-title">Dashboard</span>
                </a>
            </li>
            <li class="nav-item {{ active_class(['provider/income']) }} ">
                <a href="{{ url('provider/income') }}" class="nav-link">
            ...
            <li
                class="nav-item {{ active_class(['provider/layanan']) }} {{ active_class(['provider/layanan/tambah']) }}">
                <a href="{{ url('/provider/layanan') }}" class="nav-link">
                    <i class="link-icon" data-feather="percent"></i>
                    <span class="link-title">Layanan Aktif</span>
                </a>
            </li>
            <li class="nav-item {{ active_class(['provider/layanan/pengajuan']) }}">
                <a href="{{ route('provider.view.pengajuan') }}" class="nav-link">
                    <i class="link-icon" data-feather="trending-up"></i>
                    <span class="link-title">Ajukan Berlangganan</span>
                </a>
            </li>
            {{-- END LAYANAN --}}
            {{-- CUSTOMER --}}
            <li class="nav-item nav-category">Transaksi</li>
            <li class="nav-item {{ active_class(['provider/transaksi']) }}">
                <a href="{{ url('/provider/transaksi') }}" class="nav-link">
            ...
            <!--        <span class="link-title">Bayar Tagihan</span>-->
            <!--    </a>-->
            <!--</li>-->
            {{-- END TAGUHAN --}}
            {{-- EMAIL --}}
            ...
            <!--        <i class="link-icon mdi mdi-email-outline"></i>-->
            <!--        <span class="link-title">Pesan Masuk</span>-->
            <!--    </a>-->
            ...
            <!--    <a class="nav-link" data-toggle="collapse" href="#email" role="button"-->
            <!--        aria-expanded="{{ is_active_route(['email/*']) }}" aria-controls="email">-->
            <!--        <i class="link-icon mdi mdi-email-open-outline"></i>-->
