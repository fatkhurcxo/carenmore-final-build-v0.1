<nav class="navbar">
    ...
    <div class="navbar-content">
        <div class="d-flex align-items-center">
            <h5 class="mb-3 mb-md-0">Selamat Datang di Dashboard Carenmore</h5>
        </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown nav-profile">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{ asset('assets/images/Ojak Logo.png') }}" width="30" height="30" alt="profile">
                </a>
                <div class="dropdown-menu" aria-labelledby="profileDropdown">
                    <div class="dropdown-header d-flex flex-column align-items-center">
                        <div class="figure mb-3">
                            <img src="{{ asset('assets/images/Ojak Logo.png') }}" width="80" height="80"
                                alt="">
                        </div>
                        <div class="info text-center">
                            <p class="name font-weight-bold mb-0"> {{ $provider->pemilik ?? 'Provider Not Found' }}
                            </p>
                            <p class="email text-muted mb-3"> {{ $provider->user->email ?? 'Email Not Found' }} </p>
                        </div>
                    </div>
                    <div class="dropdown-body">
                        <ul class="profile-nav p-0 pt-3">
                            <li class="nav-item">
                                <a href="{{ route('provider.view.profile') }}" class="nav-link">
